    ...
    <AuthenticatedLayout>
        ...
        <div class="py-8 max-w-6xl mx-auto">
                        ...
                        <tr v-for="link in links.data" :key="link.id">
                            ...
                            <td class="px-6 py-4 text-sm">
                                <div v-if="link.tracking_key" class="flex items-center gap-2">
                                    <a :href="route('links.redirect', link.tracking_key)"
                            ...
                            <td class="px-6 py-4 text-sm">
                                <a :href="link.destination_url" class="text-slate-300 hover:text-slate-100 break-all"
                                    target="_blank" rel="noopener noreferrer">
            ...
            <div v-if="links.links && links.links.length > 1"
                ...
                <InertiaLink v-for="page in links.links" :key="page.url || page.label" :href="page.url || '#'"
                    v-html="page.label" :class="[
